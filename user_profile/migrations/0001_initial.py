    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_street_addreess1', models.CharField(blank=True, max_length=80, null=True)),
                ('default_street_addreess2', models.CharField(blank=True, max_length=80, null=True)),
